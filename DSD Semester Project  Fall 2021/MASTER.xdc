...
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { Blue[0] }]; #IO_L5P_T0_D06_14 Sch=led16_b
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { Blue[1] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b
